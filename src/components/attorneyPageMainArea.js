...
import '../style/attorneyPageMainArea.css';

function attorneyPageMainArea() {
    return (
        <div className='attorneyPageMainDiv'>
            ...
            {/* <div className="attorneyheadings">
...
export default attorneyPageMainArea;